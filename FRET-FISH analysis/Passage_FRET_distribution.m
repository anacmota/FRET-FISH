...
for g = 1:2
    ...
    for file = 1:9
        if strcmp(gene{g}, 'Kdm5c')
            filenum = {'iAM592'; 'iAM694'; 'iAM706';...
                'iAM632'; 'iAM660'; 'iAM574'};  
        elseif strcmp(gene{g}, 'Magix')
            filenum = {'iAM594'; 'iAM680'; 'iAM698';... 
                'iAM634';'iAM658'; 'iAM583'};
        end
        ...
        if FileNum <= 583
            Description = 'passage > 20';
        elseif FileNum > 583 && FileNum < 610
            Description = 'passage < 5';
        elseif FileNum > 630 && FileNum <= 669
            Description = '10 < passage < 20';
        elseif FileNum >= 680
            Description = 'passage < 5';
        end
...
text(10, 0.032, [num2str(min(round(EfficiencyFRET(:)))) ' - ' num2str(round(th)) ' %'],'FontSize', 8, 'Color', 'k')
text(40, 0.026, [num2str(round(th)) ' - ' num2str(round(max(EfficiencyFRET(:)))) ' %'],'FontSize', 8, 'Color', 'k')
